    ...
    <div className="">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>
            <BreadcrumbPage>Mohsine EL Mernissi</BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      {/* CONTAINER */}
            ...
            <div className="space-y-4 mt-4">
              <div className="flex flex-col gap-3 mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="">Mohsine EL Mernissi</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-bold ">Email:</span>
                  <span className="">elmernissi@gmx.de</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-bold ">Phone:</span>
                  <span className="">+212 661 56 78 90</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="bg-primary-foreground p-4 rounded-lg space-y-4">
            <div className="flex items-center gap-2">
              <Avatar className="size-12">
                <AvatarImage src="/public/assets/img/elektricitat.png" width={16} height={16}/>
                <AvatarFallback>JD</AvatarFallback>
              </Avatar>
              <h1 className="text-xl font-semibold">Mohsine EL MErnissi</h1>
            </div>
            <p className="text-sm text-muted-foreground">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis,
               blanditiis amet qui aperiam quo illo necessitatibus laborum,
               consectetur commodi eveniet voluptate minus eaque. Est numquam quo fuga minima! Tempore, corporis.
            </p>
          </div>
